...
<head>
    ...
    <meta name="author" content="Ilkin Guluzade">
    ...
    <!--title-->
    <title>Domain Search Result - Hosting Provider </title>
                                        ...
                                        <div class="col-lg-7">
                                            <div class="row mega-menu-wrap">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <ul class="sub-menu-nav-group mb-3">
                                                        <li><a class="nav-link sub-menu-nav-link"
                                                               href="http://hostlar.Ilkin Guluzade.com/template-rtl/index.html">Home Default Arabic <span class="badge badge-danger ml-2">RTL</span></a></li>
                                                    </ul>
                                ...
                                ?>
                                        <table class="table vps-hosting-pricing-table domain-search-result-table alert-table mb-5">
                                            ...
                                            <tr class="vps-pricing-row border-accent-primary">
                                                ...
                                                <td>
                                                    <a href="http://whmcs.Ilkin Guluzade.com/cart.php?a=add&domain=register&query=<?php echo $_GET['domain']; ?>" class="btn secondary-solid-btn">Add to Cart</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-5 col-lg-5">
                        <p class="copyright-text pb-0 mb-0">Copyrights © 2021. All
                            rights reserved by
                            <a href="https://www.linkedin.com/in/guluzvde/" target="_blank">Ilkin Guluzade</a></p>
                    </div>
